...
const NFTCard = ({ nft }: any) => {
  ...
  return (
      <Link href={"/"} className='z-1'>
          <div className={`flex-1 min-w-64 max-w-max xs:max-w-none sm:w-full sm:min-w-40 md:min-w-64 lg:min-w-[300px] ${theme === 'dark' ? 'bg-[#2e2b44]' : 'bg-white'} rounded-2xl p-4 lg:mr-8 sm:my-2 sm:mx-2 cursor-pointer shadow-[#251e67] shadow-md`}
            >
