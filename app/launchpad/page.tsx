...
const Mint = () => {
  ...
  return (
    <>
      <div className="container mt-24 w-[50%] px-24">
        ...
        <div className="">
          <form className="gap-6 text-white">
                  ...
                  >
                    ...
                    <div className="flex justify-center mt-4">
                      <svg
                        ...
                        className={`${
                          theme === "dark" ? "" : "bg-black rounded-xl"
                        } text-xl`}
                      >
                        <path
                          fill-rule="evenodd"
            ...
            <div className="flex flex-col mt-4">
              ...
              <select className="input border-nft-black-2 bg-[#0e0c15]/90 w-full placeholder:text-neutral-500 rounded-lg p-3" />
            </div>
